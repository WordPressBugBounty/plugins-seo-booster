...
?>
                            ...
                            <label class="seobooster-credits-label<?php 
echo ( $credits_ai_available ? '' : ' seobooster-credits-label--disabled' );
?>">
                                <input type="radio" name="seobooster_ai_provider" value="seobooster" <?php 
checked( $credits_ai_available && $ai_provider === 'seobooster' );
?> <?php 
disabled( !$credits_ai_available );
?>>
...
if ( !$credits_ai_available ) {
    ?>
                            <p class="description seobooster-credits-upsell">
                                <?php 
    esc_html_e( 'Pay-as-you-go AI credits for SEO suggestions and image analysis. Coming soon.', 'seo-booster' );
    ?>
                            </p>
                            <?php 
}
