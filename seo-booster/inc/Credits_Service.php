...
class Credits_Service {
    ...
    public static function sync_purchases() {
        if (!self::is_registered()) {
            return array('success' => false, 'error' => __('Not registered with Credits API.', 'seo-booster'));
        }
    ...
    private static function get_fallback_packs() {
        return array(
            array('credits' => 100,  'price' => '$14.99'),
            array('credits' => 250,  'price' => '$29.99'),
            array('credits' => 500,  'price' => '$49.99'),
            array('credits' => 1000, 'price' => '$89.99'),
            array('credits' => 2500, 'price' => '$179.99'),
        );
    }
    ...
    public static function get_checkout_url($pricing_id = null) {
        if ($pricing_id) {
            $result = self::api_request('GET', '/credits/checkout-url?pricing_id=' . urlencode($pricing_id));
