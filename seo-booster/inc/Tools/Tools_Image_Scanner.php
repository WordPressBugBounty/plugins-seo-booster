...
class Tools_Image_Scanner
{
    ...
    {
        return ['empty_alt', 'empty_title', 'empty_caption', 'empty_description'];
    }
    ...
    {
        add_action('wp_ajax_sb_tools_scan_images', [__CLASS__, 'ajax_scan_images']);
    }
    ...
    {
        $matching_ids = self::get_matching_attachment_ids($filters);
