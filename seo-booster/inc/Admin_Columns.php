...
class Admin_Columns
{
    ...
    {
        add_action('admin_init', [__CLASS__, 'add_seo_columns']);
        add_action('manage_posts_custom_column', [__CLASS__, 'display_seo_column_content'], 10, 2);
        add_action('manage_pages_custom_column', [__CLASS__, 'display_seo_column_content'], 10, 2);
        add_action('manage_edit-category_columns', [__CLASS__, 'add_taxonomy_columns']);
        add_action('manage_category_custom_column', [__CLASS__, 'display_taxonomy_column_content'], 10, 3);
        add_action('manage_edit-post_tag_columns', [__CLASS__, 'add_taxonomy_columns']);
        add_action('manage_post_tag_custom_column', [__CLASS__, 'display_taxonomy_column_content'], 10, 3);
    ...
    public static function add_seo_columns()
    {
        ...
        foreach ($post_types as $post_type) {
            ...
            add_filter("manage_{$post_type->name}_posts_columns", [__CLASS__, 'add_post_columns']);
        }
    }
