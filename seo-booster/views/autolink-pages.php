...
<div class="wrap">
    ...
    <div id="sb2_autolink_add">
        ...
        <form method="get" id="sb2_autolink_add_form" style="display: flex; flex-wrap: wrap; align-items: center; width: 100%;">
            <div style="flex: 2; min-width: 200px; padding-right: 10px;">
            ...
            <div style="flex: 3; min-width: 300px; padding-right: 10px;">
